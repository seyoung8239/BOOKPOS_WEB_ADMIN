                    ...
                    <Collapse in={open} timeout="auto" unmountOnExit>
                        <Box sx={{ margin: 1 }}>
                            ...
                            <Table size="small" aria-label="purchases">
                                ...
                                <TableRow>
                                    사업자 등록번호:{" "}
                                    {row.company_business_number}
                                </TableRow>
                                <TableRow>
                                    업태 / 종목: {row.company_business_category}
                                </TableRow>
                                <TableRow>
                                    회사 사이트: {row.company_webpage}
                                </TableRow>
                                <TableRow>
                                    사업자 주소: {row.company_addrerss}
                                </TableRow>
                                <TableRow>
                                    소속작가 수: {row.company_writers}
                                </TableRow>
                                <TableRow></TableRow>
                                <TableRow>
                                    담당자명: {row.manager_name}
                                </TableRow>
                                <TableRow>
                                    담당자 이메일: {row.manager_email}
                                </TableRow>
                                <TableRow>
                                    담당자 휴대전화: {row.manager_cell}
                                </TableRow>
                                <TableRow>
                                    담당자 유선: {row.manager_phone}
                                </TableRow>
                                <TableRow>
                                    담당자 직급: {row.manager_hier}
                                </TableRow>
                                <TableRow>
                                    세금계산서 담당자명: {row.tax_name}
                                </TableRow>
                                <TableRow>
